         ...
         <div class="container">
           <div class="form-group col-md-6">
             ...
             <div class="col-sm-9 has-error">
               <input type="text" class="form-control" id='ci_cliente' name="ci_cliente" data-toggle="tooltip" data-original-title="Solo Números. Min. 10 carácteres Max. 20 carácteres" required pattern="[0-9]{10,20}">  
             </div>
           </div>
           <div class="form-group col-md-6">
