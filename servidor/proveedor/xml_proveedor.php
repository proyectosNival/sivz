<?php
    ...
    if ($start < 0)
        $start = 0;	
    if($search=='false'){
        $SQL = "select id_proveedor,ci_ruc_proveedor,nombre_proveedor,telefono_proveedor,direccion_proveedor,estado_proveedor from proveedor ORDER BY $sidx $sord offset $start limit $limit";	
	}
    else{        
